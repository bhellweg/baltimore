...
arrests <- read_excel("C:/Users/brendan.hellweg/Desktop/Youth Arrests Analysis/BPD Youth Arrests.xlsx")
census2010 <- read_excel("C:/Users/brendan.hellweg/Desktop/Youth Arrests Analysis/Neighborhood 2010 Census Data.xlsx")
crime <- read_excel("C:/Users/brendan.hellweg/Desktop/Youth Arrests Analysis/Part One Crime 2010 to 2020.xlsx")
adultarrests <- read_excel("C:/Users/brendan.hellweg/Desktop/Youth Arrests Analysis/Adult Arrests 2012 to 2020.xlsx")
...
ydplot <- ggplot(yarrests_daily, aes(x = yarrests_daily$arrestdate, y = n)) +
  ...
  labs(x = "Date of Arrest", y = "Number of Arrests", title = "Daily Arrests in Baltimore, 2010 to 2020")
ydplot
